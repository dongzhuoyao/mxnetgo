...
newmodel.deeplabv1res101.pascal.imagesize473.scale8.freeze(second time)(fix beta,gamma;use_global_stats = not is_train)|70.7|epoch7:**73.3**,--|
...
newmodel.deeplabv2res101.cs.imagesize672.scale18||--|
|-----------------------------------|------|-------|
