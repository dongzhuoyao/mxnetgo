...
class resnext(Symbol):
    ...
    def resnext(self, units, num_stages, filter_list, num_classes, is_train, num_group, bottle_neck=True,b_lr_mult=10.0,w_lr_mult=5.0, bn_mom=0.9, workspace=256,  memonger=False):
