...
def get_dataxxx(name, meta_dir, gpu_nums):
    ds = FakeData([[batch_size, CROP_HEIGHT, CROP_HEIGHT, 3], [batch_size, CROP_HEIGHT, CROP_HEIGHT]], 5000, random=False, dtype='uint8')
    ds = BatchData(ds, args.batch_size * gpu_nums)
    #ds = PrefetchDataZMQ(ds, 1)
